...
setup.py: Setuptools script for Starter Kit: Camera Slider Demo
...
UNDERSCORE_NAME = 'starter_kit_camera_slider_demo'
CAMEL_CASE_NAME = 'Starter Kit Camera Slider Demo'
DESCRIPTION = 'Demo for Starter Kit: Camera Slider'
